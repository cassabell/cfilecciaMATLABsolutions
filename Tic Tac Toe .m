...
if strcmpi(welcome, 'Yes')
    ...
    disp('go in the top right corner. Number 2 is the top middle space. Number 3 is the top left space. ')
    ...
    disp('will be "O". Once the game is finished, if you would like to play again type "clc" to clear the ')
    disp('command window and start fresh.')
